/************************************************************************/
/* TaxSolve_VA760_2017.c - 						*/
/* Copyright (C) 2017 - Aston Roberts					*/
/* 									*/
/* Compile:   gcc taxsolve_VA760_2017.c -o taxsolve_VA760_2017		*/
/* Run:	      ./taxsolve_VA760_2017  VA_760_2017.txt 			*/
/* 									*/
...
/* 02111-1307 USA							*/
/* 									*/
/* Aston Roberts 1-10-2018	aston_roberts@yahoo.com			*/
/************************************************************************/
...
*/
 ...
 GetLineF( "L4", &L[4] );	/* Deduction for age on Jan 1, 2017. */
 ...
 GetLineF( "L20a", &L[20] );	/* Virginia tax withheld for 2017. */
 GetLineF( "L20b", &L20b );	/* Spouse's Virginia tax withheld. */

 GetLineF( "L21", &L[21] );	/* Estimated tax paid for 2017. (form 760ES) */

 GetLineF( "L22", &L[22] );	/* Amount of last year's overpayment applied toward 2017 estimated tax. */
